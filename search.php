...
/* =========================================================
   ...
   Displays the actual information submitted by the reporter.
========================================================= */
.browse-dialog-section {
    margin: 0 22px 14px;
    padding: 14px;
    border: 1px solid #e2e7ec;
    border-radius: 11px;
...
.browse-dialog-info-grid {
    display: grid;
    grid-template-columns: repeat(2, minmax(0, 1fr));
    gap: 8px;
}

.browse-dialog-info-field {
    min-width: 0;
    padding: 9px 10px;
...
.browse-dialog-info-field strong {
    display: block;
    color: #303943;
    font-size: 10px;
    line-height: 1.4;
...
.browse-dialog-description-box {
    background: #fff;
}

.browse-dialog-description-box p {
    margin: 0;
    color: #5f6c77;
    font-size: 10px;
    line-height: 1.65;
...
>
    ...
    >
        ...
        <!-- =====================================================
             ...
             Shows the actual values submitted by the reporter.
        ===================================================== -->
        <div class="browse-dialog-section browse-dialog-item-info">
            <div class="browse-dialog-section-title">
                <span class="browse-section-icon">▣</span>
                <strong>Item Information</strong>
            </div>

            <div class="browse-dialog-info-grid">
                <div class="browse-dialog-info-field">
                    <span>Item Name</span>
                    <strong id="browse-modal-info-name">—</strong>
                </div>

                <div class="browse-dialog-info-field">
                    <span>Category</span>
                    <strong id="browse-modal-info-category">—</strong>
                </div>

                <div class="browse-dialog-info-field">
                    <span>Brand</span>
                    <strong id="browse-modal-brand">—</strong>
                </div>

                <div class="browse-dialog-info-field">
                    <span>Color</span>
                    <strong id="browse-modal-color">—</strong>
                </div>
            </div>
        </div>
        ...
        <!-- =====================================================
             WHERE & WHEN
             Displays the individual location/date fields entered by the reporter.
        ===================================================== -->
        <div class="browse-dialog-section browse-dialog-location-info">
            <div class="browse-dialog-section-title">
                <span class="browse-section-icon">⌖</span>
            ...
            <div class="browse-dialog-info-grid">
                <div class="browse-dialog-info-field">
                    <span>Campus</span>
                    <strong id="browse-modal-campus">—</strong>
                </div>

                <div class="browse-dialog-info-field">
                    <span>Building</span>
                    <strong id="browse-modal-building">—</strong>
                </div>

                <div class="browse-dialog-info-field">
                    <span>Specific Area</span>
                    <strong id="browse-modal-area">—</strong>
                </div>

                <div class="browse-dialog-info-field">
                    <span>Date</span>
                    <strong id="browse-modal-event-date">—</strong>
                </div>

                <div class="browse-dialog-info-field">
                    <span>Time</span>
                    <strong id="browse-modal-event-time">—</strong>
                </div>
            </div>
        </div>
        ...
        <!-- =====================================================
             ...
             Keeps the complete user-provided description visible.
        ===================================================== -->
        <div class="browse-dialog-section browse-dialog-description-box">
            <div class="browse-dialog-section-title">
                <span class="browse-section-icon">≡</span>
                <strong>Description Provided by Reporter</strong>
            </div>

            <p id="browse-modal-full-description">No description provided.</p>
        </div>
...
(function () {
    ...
    // Enhanced item details
    const modalInfoName = document.getElementById('browse-modal-info-name');
    const modalInfoCategory = document.getElementById('browse-modal-info-category');
    const modalBrand = document.getElementById('browse-modal-brand');
    const modalColor = document.getElementById('browse-modal-color');
    const modalCampus = document.getElementById('browse-modal-campus');
    const modalBuilding = document.getElementById('browse-modal-building');
    const modalArea = document.getElementById('browse-modal-area');
    const modalEventDate = document.getElementById('browse-modal-event-date');
    const modalEventTime = document.getElementById('browse-modal-event-time');
    const modalFullDescription = document.getElementById('browse-modal-full-description');
    ...
    function openItemModal(data) {
        ...
        // Populate the enhanced details using the actual reporter-submitted values.
        if (modalInfoName) {
            modalInfoName.textContent = data.name || 'Not specified';
        }

        if (modalInfoCategory) {
            modalInfoCategory.textContent = data.category || 'Not specified';
        }

        if (modalBrand) {
            modalBrand.textContent = data.brand || 'Not specified';
        }

        if (modalColor) {
            modalColor.textContent = data.color || 'Not specified';
        }

        if (modalCampus) {
            modalCampus.textContent = data.campusLocation || 'Not specified';
        }

        if (modalBuilding) {
            modalBuilding.textContent = data.building || 'Not specified';
        }

        if (modalArea) {
            modalArea.textContent = data.specificArea || 'Not specified';
        }

        if (modalEventDate) {
            modalEventDate.textContent = data.date || 'Not specified';
        }

        if (modalEventTime) {
            modalEventTime.textContent = data.time || 'Not specified';
        }
