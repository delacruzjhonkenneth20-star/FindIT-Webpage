...
<style>
/* =========================================================
   ENHANCED CLAIM ITEM DETAILS
   Matches the structured details used in My Reports.
========================================================= */
...
.claim-modal-info-grid {
    display: grid;
    grid-template-columns: repeat(2, minmax(0, 1fr));
    gap: 8px;
}

.claim-modal-info-field {
    min-width: 0;
    padding: 10px 11px;
...
.claim-modal-description-box {
    background: #fff;
}

.claim-modal-description-box p {
    margin: 0;
    color: #5f6c77;
    font-size: 11px;
    line-height: 1.65;
...
>
    ...
    >
        ...
        <div class="claim-modal-section">
            ...
            <div class="claim-modal-section-title">
                <span class="claim-modal-section-icon">▣</span>
                <strong>Item Information</strong>
            </div>

            <div class="claim-modal-info-grid">

                <div class="claim-modal-info-field">
                    <span>Item Name</span>
                    <strong id="claim-modal-info-name">—</strong>
                </div>

                <div class="claim-modal-info-field">
                    <span>Category</span>
                    <strong id="claim-modal-info-category">—</strong>
                </div>

                <div class="claim-modal-info-field">
                    <span>Brand</span>
                    <strong id="claim-modal-brand">—</strong>
                </div>

                <div class="claim-modal-info-field">
                    <span>Color</span>
                    <strong id="claim-modal-color">—</strong>
                </div>
        ...
        <div class="claim-modal-section">
            ...
            <div class="claim-modal-info-grid">
                ...
                <div class="claim-modal-info-field">
                    <span>Campus</span>
                    <strong id="claim-modal-campus">—</strong>
                </div>

                <div class="claim-modal-info-field">
                    <span>Building</span>
                    <strong id="claim-modal-building">—</strong>
                </div>

                <div class="claim-modal-info-field">
                    <span>Floor</span>
                    <strong id="claim-modal-floor">—</strong>
                </div>

                <div class="claim-modal-info-field">
                    <span>Specific Area</span>
                    <strong id="claim-modal-area">—</strong>
                </div>

                <div class="claim-modal-info-field">
                    <span>Date</span>
                    <strong id="claim-modal-event-date">—</strong>
                </div>

                <div class="claim-modal-info-field">
                    <span>Time</span>
                    <strong id="claim-modal-event-time">—</strong>
                </div>
        ...
        <div class="claim-modal-section claim-modal-description-box">
            ...
            <p id="claim-modal-full-description">
...
(function () {
    ...
    const modalInfoName =
        document.getElementById(
            'claim-modal-info-name'
        );

    const modalInfoCategory =
        document.getElementById(
            'claim-modal-info-category'
        );
    ...
    const modalEventDate =
        document.getElementById(
            'claim-modal-event-date'
        );

    const modalEventTime =
        document.getElementById(
            'claim-modal-event-time'
        );

    const modalFullDescription =
        document.getElementById(
            'claim-modal-full-description'
        );
