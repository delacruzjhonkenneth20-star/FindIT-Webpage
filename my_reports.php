...
>
    ...
    >
        ...
        <div class="my-report-dialog-section">

            <div class="my-report-dialog-section-title">
                <span class="my-report-dialog-section-icon">▣</span>
                <strong>Item Information</strong>
            </div>

            <div class="my-report-dialog-info-grid">

                <div class="my-report-dialog-info-field">
                    <span>Item Name</span>
                    <strong id="my-report-modal-info-name">—</strong>
                </div>

                <div class="my-report-dialog-info-field">
                    <span>Category</span>
                    <strong id="my-report-modal-info-category">—</strong>
                </div>

                <div class="my-report-dialog-info-field">
                    <span>Brand</span>
                    <strong id="my-report-modal-brand">—</strong>
                </div>

                <div class="my-report-dialog-info-field">
                    <span>Color</span>
                    <strong id="my-report-modal-color">—</strong>
                </div>
        ...
        <div class="my-report-dialog-section">
            ...
            <div class="my-report-dialog-info-grid">
                ...
                <div class="my-report-dialog-info-field">
                    <span>Campus</span>
                    <strong id="my-report-modal-campus">—</strong>
                </div>

                <div class="my-report-dialog-info-field">
                    <span>Building</span>
                    <strong id="my-report-modal-building">—</strong>
                </div>

                <div class="my-report-dialog-info-field">
                    <span>Specific Area</span>
                    <strong id="my-report-modal-area">—</strong>
                </div>

                <div class="my-report-dialog-info-field">
                    <span>Date</span>
                    <strong id="my-report-modal-event-date">—</strong>
                </div>

                <div class="my-report-dialog-info-field">
                    <span>Time</span>
                    <strong id="my-report-modal-event-time">—</strong>
                </div>
        ...
        <div class="my-report-dialog-section my-report-dialog-description-box">
            ...
            <p id="my-report-modal-full-description">
                No description provided.
            </p>
...
<style>
/* =========================================================
   ENHANCED MY REPORT DETAILS
   Shows the actual information submitted by the reporter.
========================================================= */

.my-report-dialog-section {
    margin: 0 28px 14px;
    padding: 14px;
...
.my-report-dialog-section-title {
    display: flex;
    align-items: center;
    gap: 7px;
    margin-bottom: 11px;
...
.my-report-dialog-info-grid {
    display: grid;
    grid-template-columns: repeat(2, minmax(0, 1fr));
    gap: 8px;
}

.my-report-dialog-info-field {
    min-width: 0;
    padding: 10px 11px;
...
.my-report-dialog-info-field span {
    display: block;
    margin-bottom: 4px;
    color: #89949e;
    font-size: 8px;
...
.my-report-dialog-info-field strong {
    display: block;
    color: #303943;
    font-size: 11px;
    line-height: 1.45;
...
.my-report-dialog-description-box {
    background: #fff;
}

.my-report-dialog-description-box p {
    margin: 0;
    color: #5f6c77;
    font-size: 11px;
    line-height: 1.65;
...
(function () {
    ...
    const modalInfoName =
        document.getElementById(
            'my-report-modal-info-name'
        );

    const modalInfoCategory =
        document.getElementById(
            'my-report-modal-info-category'
        );

    const modalBrand =
        document.getElementById(
            'my-report-modal-brand'
        );

    const modalColor =
        document.getElementById(
            'my-report-modal-color'
        );

    const modalCampus =
        document.getElementById(
            'my-report-modal-campus'
        );

    const modalBuilding =
        document.getElementById(
            'my-report-modal-building'
        );

    const modalArea =
        document.getElementById(
            'my-report-modal-area'
        );

    const modalEventDate =
        document.getElementById(
            'my-report-modal-event-date'
        );

    const modalEventTime =
        document.getElementById(
            'my-report-modal-event-time'
        );

    const modalFullDescription =
        document.getElementById(
            'my-report-modal-full-description'
        );
    ...
    function openModal(data) {
        ...
        if (modalInfoName) {
            modalInfoName.textContent =
                data.name || 'Not specified';
        }

        if (modalInfoCategory) {
            modalInfoCategory.textContent =
        ...
        if (modalCampus) {
            modalCampus.textContent =
                data.campusLocation || 'Not specified';
        }

        if (modalBuilding) {
            modalBuilding.textContent =
                data.building || 'Not specified';
        }

        if (modalArea) {
            modalArea.textContent =
                data.specificArea || 'Not specified';
        }
